              ...
              <div className="col-span-12 lg:col-span-9">
                ...
                <div>
                  <h1 className="text-[28px] font-[600] leading-[40px] py-3">
                    <span className="text-[#464646] font-[400]"> Send </span>us
                    a Message
                  </h1>
                ...
                <div className="mb-5 mt-14 ">
                  <div className="flex flex-col lg:flex-row justify-start items-center  lg:justify-around">
                    <div class="my-2 lg:my-4">
                      ...
                      <input
                        class="shadow appearance-none border rounded w-60 lg:w-80  py-3.5 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="Full Name"
                        type="text"
                  ...
                  <div className="flex flex-col lg:flex-row justify-start lg:justify-around align-middle items-center">
                    <div>
                      <div class="my-2 lg:my-4">
                        <label
                          class="block text-[#999] text-sm font-bold mb-2"
                  ...
                  <div className="flex  justify-center lg:justify-end gap-3 lg:gap-8 my-5">
                    <div className="bg-[#a175aa] text-center w-32 lg:w-40 text-white text-[15.5px] font-[500] hover:bg-[#9760a2]  py-3.5 lg:py-4 cursor-pointer px-[5px] lg:px-[25px] rounded-full">
                      Send Message
                    </div>
                    <div className="bg-transparent text-center  w-32 lg:w-40 text-[#999] hover:text-gray-400 border-2 border-gray-300 hover:border-gray-400 text-[15.5px] font-[500] py-3.5 lg:py-4 px-[5px] lg:px-[25px] cursor-pointer rounded-full">
                      Clear Form
                    </div>
                  </div>
                </div>
