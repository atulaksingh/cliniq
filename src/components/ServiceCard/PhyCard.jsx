...
function PhyCard() {
  return (
    <>
      <div className="flex flex-col lg:flex-row justify-between  items-start gap-5 pb-5">
        ...
        <div className="w-[100%] lg:w-[50%]">
          ...
          <p className="text-[#999] text-[14px] font-[400] leading-[1.50rem]">
            ...
            your work-related needs and goals. We take a team approach and will
            consult with your employer and case manager, if necessary.
