...
function Header() {
  return (
    <>
      <div className="">
        <div className="flex justify-between align-middle items-center p-6 mx-20">
          <div>
          ...
          <div className="flex justify-between align-middle items-center gap-5">
            <Link to={"/"}>
              <div className="text-[18px] font-[700] leading-[28px] text-[#828282] hover:text-[#56afd5] cursor-pointer">
                Home
              </div>
            </Link>
            <Link to={"/about"}>
            ...
            <Link to={"/Service"}>
              <div class="group inline-block relative">
                <button class=" py-2  rounded inline-flex items-center text-[18px] font-[700] leading-[28px] text-[#828282] hover:text-[#56afd5] cursor-pointer">
